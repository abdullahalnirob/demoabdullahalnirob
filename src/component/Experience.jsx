...
const Experience = () => {
	return (
		<section id='ex' className="bg-white" style={{overflowX:"hidden"}}>
				...
				<div className="grid gap-4 mx-4 sm:grid-cols-12">
					...
					<div className="relative col-span-12 px-4 space-y-6 sm:col-span-9">
						<div className="col-span-12 space-y-12 relative px-4 sm:col-span-8 sm:space-y-8 sm:before:absolute sm:before:top-2 sm:before:bottom-0 sm:before:w-0.5 sm:before:-left-3 before:dark:bg-gray-300">
							<div data-aos="fade-left" className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#3b3b3b]">
							...
							<div data-aos="fade-left" className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#3b3b3b]">
								...
								<p className="mt-3 text-xl lg:text-sm">On June 21, I founded Extra Digital, a web development agency where I dedicated myself fully to building a strong foundation. Despite my efforts, I encountered some challenges that led me to temporarily close the agency. However, my passion for web development and my vision for Extra Digital remain unwavering. I am planning to relaunch the agency soon, with a renewed focus and determination to overcome any obstacles. My goal is to make Extra Digital a leading name in the industry, offering top-tier web development services.</p>
							</div>
							<div data-aos="fade-left" className="flex flex-col sm:relative sm:before:absolute sm:before:top-2 sm:before:w-4 sm:before:h-4 sm:before:rounded-full sm:before:left-[-35px] sm:before:z-[1] before:dark:bg-[#3b3b3b]">
